...
bibliography: C:/Users/crist/Documents/DOC OLD/Doc_espan/Marihuana_law/bib_lm.bib  #no va a dectecta por la carpeta que tiene "ñ" y posible el "espacio"
biblio-style: apsr
...
crime_t <- read.csv("C:/Users/crist/Documents/DOC OLD/Doc español/Marihuana_law/data/crime_t.csv", 
                  stringsAsFactors = T, 
                  sep = ";")  

proj <- read.csv("C:/Users/crist/Documents/DOC OLD/Doc español/Marihuana_law/data/Data_final.csv", 
                   stringsAsFactors = T, 
                   sep = ",")
...
![Regresión Discontinua de la tasa de Criminalidad en función de los años \label{plot2}](C:/Users/crist/Documents/DOC OLD/Doc_espan/Marihuana_law/pol_imp3.PNG){width=80%}
...
table3 <- stargazer(m1.n, 
                    ...
                    m3.n, 
                    m4.n, 
                   style="ajps", header=FALSE, type="latex",
...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth,height=\textheight]{C:/Users/crist/Documents/DOC OLD/Doc_espan/pol_imp.pdf}
